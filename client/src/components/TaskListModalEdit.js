                    ...
                    <div className="relative bg-white rounded-lg shadow bg-[#FFFFFF]" onClick={e => e.stopPropagation()}>
                        ...
                        <form  onSubmit={editTodo} className="px-6 pb-4 space-y-3 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                            ...
                            <div>
                                ...
                                <select value={category} onChange={(e) => setCategory(e.target.value)} name="category" id="category" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-2' required>
                                    {/* <option value="" selected disabled hidden>Not started</option>
                                    <option value="In Progress">In Progress</option>
                                    <option value="Complete">Complete</option> */}
                                    <DisplayOptions curr_category={props.task.category} key={props.task.task_id}/>
                                </select>
