...
|2|Add participants|admin presses add participants|/api/addParticipants|{group_id: INT, members: list(user_id: INT)}|`POST`|200 for success, 400 for failure. 400: {error}, 200: {}|N/A
